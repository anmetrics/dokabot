...
export class MiniReversalDcaStrategy implements IStrategy {
  ...
  private async start(timeframe: '1m' | '3m' | '5m' | '15m' | '30m') {
    console.log(
      `Starting MINI RSI Reversal + DCA Strategy for ${this.symbol} [${timeframe}]R, baseBuyUsd: ${this.baseBuyUsd}, BaseProfit:${this.minProfitPct}, maxBuyPrice: ${this.maxBuyPrice}`,
    );
